        ...
        <form method="POST" action="{{ route('admin.employees.update', $employee->id) }}"
            ...
            <div class="space-y-6">
                ...
                <div class="p-6 bg-white rounded-lg shadow-md">
                    <p class="text-sm text-gray-600">Update the form to edit employee record.</p>
                    <div class="grid grid-cols-1 mt-5 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="col-span-full">
                            <label for="password" class="block text-sm font-medium text-gray-900">Password (leave empty
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <input type="tel" name="phone" id="phone"
                                    value="{{ old('phone', $employee->phone) }}" autocomplete="tel"
                                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <textarea rows=5 name="address" id="address" autocomplete="street-address"
                                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                                    placeholder="Full Address" required>{{ old('address', $employee->address) }}</textarea>
                            </div>
                        </div>
                ...
                <div class="flex items-center justify-end mt-6 gap-x-6">
                    ...
                    <script>
                        function confirmUpdate() {
                            return confirm('Are you sure you want to employee this employee? This action cannot be undone.');
                        }
                    </script>
                </div>
            </div>
